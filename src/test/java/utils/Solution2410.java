...
public class Solution2410 {
    ...
    public int matchPlayersAndTrainers(int[] players, int[] trainers) {
        /**
         * 思路分析：
         * 该内容其实是一个二分图的最大匹配问题，使用通用的匈牙利算法可解。
         * 但是该问题，很明显是有规律可循的，因此选用通用解法不是最优解。
         *
         * 通过将其排序，然后观察邻接矩阵可以找到技巧
         */
        Arrays.sort(players);
...
//        }
    ...
    public static void main(String[] args) {
        System.out.println(new Solution2410().matchPlayersAndTrainers(
                new int[]{1, 1, 1},
                new int[]{10}
        ));
        System.out.println(new Solution2410().matchPlayersAndTrainers(
